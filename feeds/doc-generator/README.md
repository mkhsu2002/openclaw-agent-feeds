...
Documentation workflow prompt seed that helps agents generate docs from real code and repository structure.

文件生成工作流提示詞種子，幫助 Agent 從真實程式碼與 repo 結構產出文件。
