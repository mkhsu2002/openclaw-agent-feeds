# 龍蝦通用核心飼料 (L0) / Universal Core Feed (L0)
...
Baseline prompt seed that helps a capable agent reason carefully before changing files, creating Skills, or modifying workspace behavior.

基線提示詞種子，幫助高能力 Agent 在改檔、建立 Skills 或調整 workspace 行為前，更謹慎地理解意圖、檢查上下文並提出安全計畫。
