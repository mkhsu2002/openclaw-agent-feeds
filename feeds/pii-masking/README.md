# PII 自動脫敏護欄 / PII Masking Guardrails
...
PII safety prompt seed for identifying, masking, and reviewing sensitive information before processing or output.

PII 安全提示詞種子，幫助 Agent 在處理或輸出資料前標示、遮罩並審查敏感資訊。
