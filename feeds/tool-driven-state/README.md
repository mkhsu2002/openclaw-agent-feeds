...
Tool-grounding prompt seed that helps agents keep outputs tied to verifiable tool results and workspace context.

工具依賴提示詞種子，幫助 Agent 將輸出限制在可查證工具結果與 workspace context 內。
