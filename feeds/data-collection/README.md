...
Data collection workflow prompt seed for legal, polite, and reviewable collection planning.

資料採集工作流提示詞種子，幫助 Agent 規劃合法、禮貌且可審查的資料收集流程。
