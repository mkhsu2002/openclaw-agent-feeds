...
Intent clarification prompt seed that helps agents ask concrete questions and options when a task is vague.

意圖釐清提示詞種子，幫助 Agent 在任務模糊時先提出具體問題與選項。
