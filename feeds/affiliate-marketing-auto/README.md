# 聯盟行銷自動化 / Affiliate Marketing Auto

**Feed type / 類型**: Workflow Feed / 工作流 Feed
**Version / 版本**: v0.3

## Positioning / 定位

Affiliate marketing workflow prompt seed for reviewing product facts, tracking links, and disclosure needs before content generation.

聯盟行銷工作流提示詞種子，幫助 Agent 審查產品資訊、追蹤連結與揭露需求後再產出內容。
