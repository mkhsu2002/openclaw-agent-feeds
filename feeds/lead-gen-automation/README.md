...
Lead generation prompt seed for ICP clarification, lawful data sources, and contact-list quality review.

潛在客戶開發提示詞種子，幫助 Agent 釐清 ICP、合法資料來源與聯絡名單品質。
