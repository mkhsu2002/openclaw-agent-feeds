# 社群內容流量引擎 / Social Content Engine
...
Social content workflow prompt seed for platform, audience, constraint, and review alignment.

社群內容工作流提示詞種子，幫助 Agent 對齊平台、受眾、限制與審查流程。
