# 多代理協作調度員 / Multi-Agent Orchestrator
...
Multi-agent workflow prompt seed for task decomposition, deliverable definition, and subtask review.

多 Agent 工作流提示詞種子，幫助父 Agent 拆解任務、定義交付物並審查子任務輸出。
