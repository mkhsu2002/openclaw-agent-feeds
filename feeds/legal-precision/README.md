# 法律條文精算師 / Legal Precision Analyst
...
Legal analysis prompt seed for conservative, reviewable contract risk and uncertainty marking.

法律分析提示詞種子，幫助 Agent 以保守、可審查的方式標示條款風險與不確定性。
