# 自主研究代理 / Autonomous Research Agent
...
Research workflow prompt seed for source planning, cross-checking, report generation, and limitation marking.

研究工作流提示詞種子，幫助 Agent 規劃資料來源、交叉查核、產出報告並標示限制。
