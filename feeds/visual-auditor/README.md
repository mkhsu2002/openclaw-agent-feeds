...
Visual review prompt seed for vision-capable agents inspecting UI, screenshots, and responsive issues.

視覺審查提示詞種子，幫助具備視覺能力的 Agent 檢查 UI、截圖與響應式問題。
