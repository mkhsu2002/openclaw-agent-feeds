# 語音指令邏輯提取器 / Voice-to-Logic Extractor
...
Voice-to-task prompt seed that converts conversational input into actionable requirements and clarifying questions.

語音到任務提示詞種子，幫助 Agent 將口語內容整理成可執行需求與待確認事項。
