...
Market research prompt seed for scoping, source checks, and avoiding fabricated market numbers.

市場研究提示詞種子，幫助 Agent 限縮研究範圍、查核來源並避免捏造市場數據。
