# 軟體專案架構代理 / Software Project Architect

**Feed type / 類型**: Skill-Building Feed / Skill 建置 Feed
**Version / 版本**: v0.3

## Positioning / 定位

Skill-building and software workspace prompt seed for repo inspection, architecture planning, and safe Skill or instruction creation.

Skill 建置與軟體工作空間提示詞種子，幫助 Agent 檢查 repo、提出架構計畫並安全建立 Skills 或指令。
