# 高精度推理提示詞種子 / High-Precision Reasoning Feed

**Feed type / 類型**: Baseline Feed / 基線 Feed
**Version / 版本**: v0.3

## Positioning / 定位

High-precision reasoning prompt seed that helps an agent turn vague tasks into reviewable constraints, assumptions, and validation steps without claiming deterministic output.

高精度推理提示詞種子，幫助 Agent 將模糊任務轉成可審查的約束、假設與驗證步驟，但不保證跨模型完全一致。
