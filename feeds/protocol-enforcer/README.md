# 安全審查執行提示詞種子 / Safety Review Enforcer Feed

**Feed type / 類型**: Safety Feed / 安全 Feed
**Version / 版本**: v0.3

## Positioning / 定位

Safety review prompt seed that helps agents surface risks, confirmations, and rollback guidance before high-risk actions.

安全審查提示詞種子，幫助 Agent 在高風險操作前提出風險、確認與 rollback 建議。
