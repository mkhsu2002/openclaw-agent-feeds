...
Security review prompt seed for authorized scope, public intelligence, and remediation risk review.

資安審查提示詞種子，幫助 Agent 區分授權範圍、公開情報與修補風險。
