# 反幻覺邏輯護欄 / Hallucination Guardrails
...
Fact-checking prompt seed that encourages agents to mark uncertainty, cite sources, and stop guessing when evidence is insufficient.

事實查核提示詞種子，鼓勵 Agent 標示不確定性、引用來源並在缺乏證據時停止猜測。
