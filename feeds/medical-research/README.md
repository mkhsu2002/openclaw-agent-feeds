# 醫學文獻與藥理綜述助手 / Medical Research Pro

**Feed type / 類型**: Domain Expert Feed / 領域專家 Feed
**Version / 版本**: v0.3

## Positioning / 定位

Medical research prompt seed for high-evidence literature synthesis and avoiding overclaimed medical advice.

醫學研究提示詞種子，幫助 Agent 使用高證據標準整理文獻，並避免醫療建議過度宣稱。
