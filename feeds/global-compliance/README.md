# 跨國合規執行包裹器 / Global Compliance Wrapper
...
Compliance review prompt seed for surfacing legal and policy risks in cross-region data, marketing, or automation tasks.

合規審查提示詞種子，幫助 Agent 在跨區資料、行銷或自動化任務中標示法律與政策風險。
